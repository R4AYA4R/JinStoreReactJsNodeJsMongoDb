...
class UserController {
    ...
    async deleteComment(req, res, next) {
        ...
        try {
            ...
            const deletedComment = await commentModel.findByIdAndDelete(commentId); // находим объект комментария в базе данных по id(который равен commentId (id у объекта комментария)) и удаляем его

            return res.json(deletedComment);  // возвращаем на клиент удаленный объект комментария
