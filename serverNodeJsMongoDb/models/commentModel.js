...
const CommentSchema = new Schema({
    ...
    adminReply:{
        ...
        text:{type:String,required:true}, // указываем поле для самого текста ответа

        createdTime:{type:String,required:true} // указываем поле,в котором будем хранить значение даты,когда создался этот комментарий
