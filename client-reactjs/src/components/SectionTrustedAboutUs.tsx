    ...
    return (
        <section ref={sectionNewArrivals} id="sectionNewArrivals" className={onScreen.sectionNewArrivalsIntersecting ? 'sectionNewArrivals sectionNewArrivals__active sectionTrusted' : 'sectionNewArrivals sectionTrusted'}>
            <div className="container">
                <div className="sectionTrusted__inner sectionTrusted__innerTrue">
                    <div className="sectionTrusted__info sectionTrusted__infoTrue">
                        ...
                        <div className="sectionTrusted__info-items">
                            <div className="sectionTrusted__items-leftBlock">
                                <div className="sectionTrusted__items-item">
                                    <img src="/images/sectionTrusted/Icon.svg" alt="" className="sectionTrusted__item-img" />
                                ...
                                <div className="sectionTrusted__items-item">
                                    <img src="/images/sectionTrusted/Icon (1).svg" alt="" className="sectionTrusted__item-img" />
                                    <div className="sectionTrusted__item-textBlock">
                                ...
                                <div className="sectionTrusted__items-item">
                                    <img src="/images/sectionTrusted/Icon (2).svg" alt="" className="sectionTrusted__item-img" />
                                    <div className="sectionTrusted__item-textBlock">
                            ...
                            <div className="sectionTrusted__items-rightBlock">
                                <div className="sectionTrusted__items-item">
                                    <img src="/images/sectionTrusted/Icon (3).svg" alt="" className="sectionTrusted__item-img" />
                                    <div className="sectionTrusted__item-textBlock">
                                ...
                                <div className="sectionTrusted__items-item">
                                    <img src="/images/sectionTrusted/Icon (4).svg" alt="" className="sectionTrusted__item-img" />
                                    <div className="sectionTrusted__item-textBlock">
                                ...
                                <div className="sectionTrusted__items-item">
                                    <img src="/images/sectionTrusted/Icon (5).svg" alt="" className="sectionTrusted__item-img" />
                                    <div className="sectionTrusted__item-textBlock">
